...
namespace ChickenDoorWebHost.Problems
{
    ...
    {
        private const string ProblemTypeNamespace = "ChickenDoorWebHost";
        ...
        public ProblemJson NotAuthorized()
        {
            return new ProblemJson
            {
                Title = "Not Authorized",
                Detail = "No valid authentication credentials for the target resource.",
                ProblemType = ProblemTypeNamespace + ".NotAuthorized",
                StatusCode = 401
            };
        }
